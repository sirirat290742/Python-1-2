...
def draw():
    screen.fill( (50, 1, 200) )
    if StatusGame == 0:
        message = "Are you ready, press Enter key to play."
        screen.draw.text(message,topleft =(200,350),fontsize=40,
                         color="black")
    elif StatusGame == 1:
            for fruit in fruits:
                fruit.draw()
            ...
            screen.draw.text(message,topleft=(220,300),fontsize=50,
                             color="black")
            message = "Play again, press spacebar key" 
            screen.draw.text(message,topleft=(180,350),fontsize=50,
                             color="black")
